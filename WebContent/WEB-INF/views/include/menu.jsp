...
<div class="menu">
	<ul>
		...
		<li class="chapter">Ch01. <a href="<%=application.getContextPath() %>/ch01/content">Development EnvDironment</a></li>
		<li class="chapter">Ch02. <a href="<%=application.getContextPath() %>/ch02/content">RequestMapping</a></li>
		...
		<li class="chapter">Ch14. <a href="<%=application.getContextPath()%>/ch14/content">Data Access(DB 연동)</a></li>
		<li class="chapter">Ch14. <a href="<%=application.getContextPath()%>/ch14/boardlist2">Data Access(Board Sample)</a></li>
	</ul>			
</div>